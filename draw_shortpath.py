...
# 출발 노드
orig_cor =  (37.47812141790064,126.95136303359361 )
orig_node = ox.get_nearest_node(G, orig_cor)

filePath = 'C:/Users/shdbt/Desktop/DATAFILE/학술제/추천시스템_관악구/simulation_'
folderNum = 0
filePath = filePath + str(folderNum)
# 도착 노드
data = get_CorData(filePath) 
...
for i in dest_node_list :
    file = 'C:/Users/shdbt/Desktop/DATAFILE/학술제/시각화자료_관악구/'
